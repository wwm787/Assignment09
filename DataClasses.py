...
class Track():
    ...
    """
    #copied from DBiesinger Lab 09B DataClasses.py Track() constructor
    # -- Constructor -- #

    def __init__(self, trkPosit, trkTTL, trkLen):
        # -- Attributes -- #
        self.__position = trkPosit
        self.__title = trkTTL
        self.__length = trkLen

    # -- Properties -- #
    #copied from DBiesinger Lab 09B DataClasses.py Track() properties
    # Track position
    @property
    def position(self):
    ...
    #copied from DBiesinger Lab 09B DataClasses.py Track class methods
...
class CD:
    ...
    def __init__(self, cd_id: int, cd_title: str, cd_artist: str) -> None:
        ...
        try:
            ...
            self.__tracks = []  # copied from DBiesinger Lab 09B DataClasses.py CD() constructor
        except Exception as e:
            raise Exception('Error setting initial values:\n' + str(e))

    # -- Properties -- #
    # CD tracks
    @property  # copied from DBiesinger Lab 09B DataClasses.py CD() cd_tracks() property
    def cd_tracks(self):
    ...
    def add_track(self, track: Track) -> None:
        ...
        #Copied from DBiesinger Lab 09B DataClasses.py add_track()
    ...
    def rmv_track(self, track_id: int) -> None:
        ...
        #Copied from DBiesinger Lab 09B DataClasses.py rmv_track()
